...
<html lang="en">
  ...
  <body>
	    ...
	    <div class="container">
	      ...
	      <div class="collapse navbar-collapse" id="ftco-nav">
	        <ul class="navbar-nav ml-auto">
	          ...
	          <li class="nav-item"><a href="index.php#onePlusOne" class="nav-link">1+1</a></li>
	          <li class="nav-item"><a href="index.php#set" class="nav-link">Сеты</a></li>
	          <li class="nav-item"><a href="index.php#hot" class="nav-link">Теплые роллы</a></li>
	          <li class="nav-item"><a href="index.php#cold" class="nav-link">Холодные роллы</a></li>
   ...
   <div class="row justify-content-center mb-5 pb-3" style="padding-top:300px;">
          <div class="col-md-7 heading-section ftco-animate text-center">
            <h2 class="mb-4">Спасибо за заказ! Приятного аппетита?</h2>
            <div class="naming">------------------------------------------------------------------------------------</div>
            <p>Нажеемся что вы по достоинству оцените наши роллы.</p>
          </div>
        </div>


		<section class="ftco-counter ftco-bg-dark img" id="section-counter" style="background-image: url(images/bg_2.jpg); margin-top: 355px" data-stellar-background-ratio="0.5">
