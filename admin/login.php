...
<html lang="en">
  <head>
    <title>FRIENDS_NT | Доступ к админ-панели</title>
    <meta charset="utf-8">
  ...
  <body>
    ...
    <!-- END nav -->
     ...
     <div class="pricing-entry d-flex ftco-animate justify-content-center" style="padding-top: 250px;">
              <div class="desc pl-3">
                <div class="d-flex text align-items-center">
                  <h1><span class="naming">Вход в Админ панель!</span></h1>
                  <span class="price"></span>
                </div>
                <div class="d-block">
                  <form action="login.php" method="POST">
                  <p style="margin: 0 auto">Введите ваш логин:</p><input type="text" class="form-control col-md-12" name="login" style="margin-left: 0px; background-color: rgba(46, 97, 132, 0.5) !important; padding-left: 30px;"><p>
                  <p>Введите ваш пароль:</p><input class="form-control col-md-12" type="password" id="number" name="password" value="" style="margin-left: 0px; background-color: rgba(46, 97, 132, 0.5) !important; padding-left: 30px;"><p> 
                    <input type="submit" class="btn btn-block btn-warning" value="Войти" name="submit" style="margin-top: 30px;">
                  </form>
                </div>
              </div>
            </div>
    ...
    <?php 
     ...
     ?>
		...
		<section class="ftco-appointment" style="margin-top: 950px;">
